...
**双向赋能机制：**
- **AI赋能调度层**：PPO Agent 实时决策量子/经典资源最优分流，+88.3% vs FCFS（p=1.0e-42）
- **AI赋能编译层**：PPO Agent 替代传统 SABRE 做量子比特映射，SWAP门减少 76.4%
- **量子赋能AI**：量子启发式退火[^annealing-sim]为探索性方向（经典模拟退火，训练+74.5%，奖励提升统计不显著 p=0.190）
