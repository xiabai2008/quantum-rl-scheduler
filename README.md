...
| PPO vs FCFS | 综合奖励提升 86.9%（14维模型，N=50，p=3.5e-8，Cohen's d=4.09） |
...
| 实验 | 核心结论 |
|------|---------|
| 8策略对比 | PPO奖励2723 vs FCFS 1457，+86.9%（14维，p=3.5e-8，d=4.09） |
| 五维消融 | D1算法+86.9% > D4多机+86.3% > D5退火+6.4% > D2状态+2.1% |
