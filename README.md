...
| PPO vs FCFS（真机参与率） | +353%（N=10, PPO=1736 vs FCFS=383；注：混合评估环境，96步中仅1步涉及真机，"真机参与率"指每组提交1次真机任务，非性能来源；权威性能结论为仿真+20.2%） |
...
| 真机验证 | N=10 seeds, PPO=1736 vs FCFS=383 (+353%真机参与率验证；注：混合环境，96步中仅1步涉及真机，"真机参与率"指每组提交1次真机任务，非性能来源；权威性能结论为仿真+20.2%)，30/30成功 |
| 六维消融 | D1算法+20.2% > D4多机+86.3%（含规模扩展+协同）> D5退火-5.6%（20seed权威，p=0.9430不显著，旧+6.4%已废弃）> D2状态+2.1%；MLP=LSTM收敛等价 |
| 电路编译（探索性） | 公平对比v2(4×4 2D网格, 60电路同池配对, Issue #451)：全60电路p=8.40e-01不显著；深电路N=80扩充（Issue #559）：SWAP减少+38.5%（p=2.75e-02显著）；2D网格vs线性链拓扑消融SWAP-62% |
