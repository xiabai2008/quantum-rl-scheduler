...
|:--:|:--|:--:|:--:|:--:|:--:|:--:|:--:|
| 1 | **PPO (16维)** | **1982.69** | 557.25 | 35.24 | **+20.24%** | [+14.3%, +26.7%] | ✅ p=7.56e-12 |
| 2 | FCFS | 1648.91 | 502.95 | 31.81 | 基线 | — | — |
| 3 | SJF | 774.86 | 275.74 | 17.44 | -53.0% | — | ❌ n.s. (p=0.2827) |
| 4 | DQN (Random 替代) | 602.37 | 262.09 | 16.57 | -63.5% | — | ✅ p=5.681e-14 |
| 5 | Random | 602.37 | 262.09 | 16.57 | -63.5% | — | ✅ p=5.681e-14 |
| 6 | Greedy | 80.71 | 549.12 | 34.73 | -95.1% | — | n/a |
| 7 | Quantum-Only | -826.59 | 263.63 | 16.67 | -150.1% | — | n/a |
| 8 | Classical-Only | -1075.49 | 75.04 | 4.75 | -165.2% | — | n/a |

> 注：v9 已删除 DQN 模型，DQN 策略位使用 Random 替代，仅供策略完整性对比。
> SJF 与 FCFS 无显著差异（p=0.2827），说明在该环境设置下，启发式调度策略之间差异不大。
> PPO 排名第一，且与各基线差异显著（vs 真实 FCFS p=7.56e-12，vs SJF p=6.511e-62，vs Random/DQN 占位 p=1.315e-77）。
>
...
|:--|:--:|:--:|:--:|:--:|
| PPO vs FCFS | +333.78 | +20.24% | ✅ p=7.56e-12 | rank-biserial=-0.3642 |
...
> **在 16 维原生环境中（OBS_DIM=16，N=50 seeds × 5 episodes = 250 次独立运行，8.5 基线诚实化），PPO 平均奖励（1982.69±35.24）比真实 FCFS 基线（1648.91±31.81）提升 +20.24%（95% CI: [14.3%, 26.7%]，Welch t 检验，p=7.56e-12），验证了 RL 调度相对朴素路由的显著优势（旧 +123.4% 为 vs Hybrid-Default 恒 action=2 弱基线，已废弃）。**
