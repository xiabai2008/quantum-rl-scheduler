...
| 3 | SJF | 774.86 | 275.74 | 17.44 | -53.0% | — | ✅ p=2.28e-60（显著劣于 FCFS） |
...
> SJF 与 FCFS 差异显著（p=2.28e-60，8.8 修正；旧 p=0.2827 为错误值已废弃），SJF 显著劣于 FCFS（-53.0%）。
...
- **SJF vs FCFS**: 差异显著（p=2.28e-60，8.8 修正；旧 p=0.2827 为错误值已废弃），SJF 显著劣于 FCFS（-53.0%）
