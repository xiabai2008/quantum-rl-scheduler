...
|:--|:--|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| DQN vs FCFS | Welch t 检验 | -7.9401 | 2.79e-98 | ✅ 是 | Cohen's d=-0.7102 | -160.06 | [-199.75, -120.37] | [-18.9%, -11.4%] |
...
| DQN vs PPO | Welch t 检验 | -25.2468 | 3.02e-118 | ✅ 是 | Cohen's d=-2.2581 | -1457.38 | [-1570.96, -1343.81] | [-64.3%, -59.5%] |
| FCFS vs Random | Welch t 检验 | 7.9401 | 2.79e-98 | ✅ 是 | Cohen's d=0.7102 | 160.06 | [120.37, 199.75] | [+12.9%, +23.4%] |
...
| Random vs PPO | Welch t 检验 | -25.2468 | 3.02e-118 | ✅ 是 | Cohen's d=-2.2581 | -1457.38 | [-1570.96, -1343.81] | [-64.3%, -59.5%] |
...
| SJF vs PPO | Mann-Whitney U 检验 | 4428.0000 | 1.11e-70 | ✅ 是 | rank-biserial correlation=-0.8583 | -1288.61 | [-1396.01, -1181.22] | [-56.9%, -52.6%] |

## 三、详细解释

### DQN vs FCFS

> 使用 Welch t 检验 比较 DQN 与 FCFS：DQN 平均奖励低于FCFS 160.06（95% CI: [-199.75, -120.37]）；统计量=-7.9401，p=2.79e-98。经 Bonferroni 校正（28 次比较，校正 α=0.0018），差异显著。效应量 Cohen's d=-0.7102（中效应）。
...
> 使用 Welch t 检验 比较 DQN 与 PPO：DQN 平均奖励低于PPO 1457.38（95% CI: [-1570.96, -1343.81]）；统计量=-25.2468，p=3.02e-118。经 Bonferroni 校正（28 次比较，校正 α=0.0018），差异显著。效应量 Cohen's d=-2.2581（大效应）。

### FCFS vs Random

> 使用 Welch t 检验 比较 FCFS 与 Random：FCFS 平均奖励高于Random 160.06（95% CI: [120.37, 199.75]）；统计量=7.9401，p=2.79e-98。经 Bonferroni 校正（28 次比较，校正 α=0.0018），差异显著。效应量 Cohen's d=0.7102（中效应）。
...
> 使用 Welch t 检验 比较 Random 与 PPO：Random 平均奖励低于PPO 1457.38（95% CI: [-1570.96, -1343.81]）；统计量=-25.2468，p=3.02e-118。经 Bonferroni 校正（28 次比较，校正 α=0.0018），差异显著。效应量 Cohen's d=-2.2581（大效应）。
...
> 使用 Mann-Whitney U 检验 比较 SJF 与 PPO：SJF 平均奖励低于PPO 1288.61（95% CI: [-1396.01, -1181.22]）；统计量=4428.0000，p=1.11e-70。经 Bonferroni 校正（28 次比较，校正 α=0.0018），差异显著。效应量 rank-biserial correlation=-0.8583（大效应）。
