...
|:--:|:--|:--:|:--:|:--:|:--:|:--:|
| 1 | PPO | 2348.91 | 857.25 | 54.22 | +123.4% | [+113.3%, +133.5%] |
| 2 | SJF | 1060.30 | 109.71 | 6.94 | +0.8% | [-0.6%, +2.3%] |
| 3 | FCFS | 1051.59 | 58.34 | 3.69 | 基线 | — |
| 4 | DQN | 891.53 | 313.35 | 19.82 | -15.2% | [-18.9%, -11.4%] |
| 5 | Random | 891.53 | 313.35 | 19.82 | -15.2% | [-18.9%, -11.4%] |
| 6 | Greedy | -134.18 | 552.17 | 34.92 | -112.8% | [-119.2%, -106.3%] |
| 7 | Quantum-Only | -940.56 | 205.83 | 13.02 | -189.4% | [-191.9%, -186.9%] |
| 8 | Classical-Only | -1128.79 | 59.17 | 3.74 | -207.3% | [-208.4%, -206.3%] |
...
|:--|:--:|:--:|:--:|:--:|:--:|
| DQN | 250 | 891.53 | 313.35 | 85.22 | 1817.23 |
| FCFS | 250 | 1051.59 | 58.34 | 884.45 | 1169.36 |
| Random | 250 | 891.53 | 313.35 | 85.22 | 1817.23 |
| Quantum-Only | 250 | -940.56 | 205.83 | -1238.56 | 110.11 |
| Classical-Only | 250 | -1128.79 | 59.17 | -1267.91 | -951.73 |
| Greedy | 250 | -134.18 | 552.17 | -1244.24 | 1385.65 |
| SJF | 250 | 1060.30 | 109.71 | 856.86 | 1509.50 |
| PPO | 250 | 2348.91 | 857.25 | 221.14 | 4785.93 |
...
| FCFS vs PPO | Welch t 检验 | -23.8732 | 1.449e-66 | ✅ 是 | Cohen's d=-2.1353 | -1297.32 | [-1404.35, -1190.30] | [-57.2%, -53.1%] |
...
> 使用 Welch t 检验 比较 FCFS 与 PPO：FCFS 平均奖励低于PPO 1297.32（95% CI: [-1404.35, -1190.30]）；统计量=-23.8732，p=1.449e-66。经 Bonferroni 校正（28 次比较，校正 α=0.0018），差异显著。效应量 Cohen's d=-2.1353（大效应）。
...
| FCFS vs PPO | Cohen's d=-2.1353 | 250/250 | 1.0000 | 5 | 0.2511 |
...
- **PPO vs FCFS**：Cohen's d=-2.1353（大效应），当前 N1=250, N2=250 的检验力 = 1.0000（远超 80% 标准）；检测该效应量仅需每组约 5 个样本。
