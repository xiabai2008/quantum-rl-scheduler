...
|:--|:--:|:--:|:--:|
| 浅电路 (20 电路) | 1.40 ± 2.56 | 1.90 ± 1.89 | -35.7% |
| 中电路 (20 电路) | 8.50 ± 12.45 | 8.65 ± 2.76 | -1.8% |
| 深电路 (20 电路) | 24.85 ± 27.09 | 13.60 ± 3.56 | +45.3% |
...
|:--|:--|
| W 统计量 | 854 |
| p 值（单侧 PPO < SABRE） | 5.87e-01 |
| 配对数 | 60 |
| rank-biserial 效应量 | -0.033 |
| Cohen's d（配对） | 0.200 |
| 显著性 (α=0.05) | [FAIL] 不显著 |

**结论**: p = 5.87e-01，未达到 0.05 显著性水平，PPO 平均 SWAP 数较低但差异不显著。

### 提升百分比 95% CI

| 方法 | CI |
|:--|:--|
| Bootstrap (2000 次) | [-7.0%, 51.0%] |
...
|:--|:--|
| Wilcoxon W | 363 |
| p 值（单侧 PPO < SABRE） | 2.64e-01 |
| rank-biserial 效应量 | 0.115 |
| Cohen's d（配对） | 0.260 |
| Bootstrap 95% CI | [-4.8%, 52.8%] |
| 显著性 (α=0.05) | [FAIL] 不显著 |

**子集结论**: p = 2.64e-01，子集检验未达到 0.05 显著性水平，PPO 平均较低但差异不显著。
...
| 本公平对比 v2（全 60 电路） | 11.58 | 8.05 | +30.5% | [PASS] 同池配对 | [PASS] seed=42 | p=5.87e-01 |
| 本公平对比 v2（中+深 40 电路） | 16.68 | 11.12 | +33.3% | [PASS] 同池配对 | [PASS] seed=42 | p=2.64e-01 |
...
全60电路平均变化 +30.5%（p=5.87e-01），
中+深电路子集变化 +33.3%（p=2.64e-01），
...
3. **当前模型评测结果**：全60电路 SABRE avg=11.58 SWAP，
   PPO avg=8.05 SWAP，变化 +30.5%
   （p=5.87e-01）；中+深子集变化 +33.3%（p=2.64e-01）。
