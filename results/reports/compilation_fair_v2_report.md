...
|:--|:--:|:--:|:--:|
| 浅电路 (20 电路) | 1.35 ± 2.72 | 1.90 ± 1.89 | -40.7% |
| 中电路 (20 电路) | 8.65 ± 12.97 | 8.65 ± 2.76 | +0.0% |
| 深电路 (20 电路) | 24.95 ± 27.52 | 13.60 ± 3.56 | +45.5% |
...
|:--|:--|
| W 统计量 | 828 |
| p 值（单侧 PPO < SABRE） | 5.95e-01 |
| 配对数 | 60 |
| rank-biserial 效应量 | -0.037 |
| Cohen's d（配对） | 0.201 |
| 显著性 (α=0.05) | [FAIL] 不显著 |

**结论**: p = 5.95e-01，未达到 0.05 显著性水平，PPO 平均 SWAP 数较高但差异不显著。

### 提升百分比 95% CI

| 方法 | CI |
|:--|:--|
| Bootstrap (2000 次) | [-8.9%, 51.2%] |
...
|:--|:--|
| Wilcoxon W | 343 |
| p 值（单侧 PPO < SABRE） | 2.56e-01 |
| rank-biserial 效应量 | 0.121 |
| Cohen's d（配对） | 0.262 |
| Bootstrap 95% CI | [-5.0%, 52.9%] |
| 显著性 (α=0.05) | [FAIL] 不显著 |

**子集结论**: p = 2.56e-01，子集检验未达到 0.05 显著性水平，PPO 平均较高但差异不显著。
...
| 本公平对比 v2（全 60 电路） | 11.65 | 8.05 | +30.9% | [PASS] 同池配对 | [PASS] seed=42 | p=5.95e-01 |
| 本公平对比 v2（中+深 40 电路） | 16.80 | 11.12 | +33.8% | [PASS] 同池配对 | [PASS] seed=42 | p=2.56e-01 |
...
全60电路平均变化 +30.9%（p=5.95e-01），
中+深电路子集变化 +33.8%（p=2.56e-01），
...
3. **当前模型评测结果**：全60电路 SABRE avg=11.65 SWAP，
   PPO avg=8.05 SWAP，变化 +30.9%
   （p=5.95e-01）；中+深子集变化 +33.8%（p=2.56e-01）。
4. **统计结论**：PPO平均SWAP数高于SABRE但差异未达统计显著性(p>0.05)，
   深电路类别改进+45.5%，
