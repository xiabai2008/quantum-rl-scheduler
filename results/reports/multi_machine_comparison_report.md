...
| **协同算法优势** | MAPPO 协同决策 vs 独立决策的增量 | +84.6% vs 独立PPO |
...
- 协同算法优势：MAPPO 在同资源下比无协同 PPO 高 +84.6%
...
1. **协同优势**：MAPPO 在同资源下比独立 PPO 高 +84.6%（p=0.0188），证明多智能体协同决策的有效性
2. **规模效率**：3倍资源实际获得 24% 的理论吞吐，剩余 76% 为调度开销/资源碎片
3. **诚实叙事**：原 +86.3% 应拆解为"规模扩展效率 24% + 协同优势 +84.6%"
