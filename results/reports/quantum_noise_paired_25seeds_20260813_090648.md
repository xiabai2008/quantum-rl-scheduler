...
> **显著性水平**: α = 0.05
> **生成时间**: 2026-08-13T09:06:48.079734+08:00
...
|:--|:--:|:--:|
| 配对样本数 N | 25 | 25 |
| seed 平均奖励 均值 ± 标准差 | 2001.4492 ± 242.4991 | 1755.2575 ± 214.1818 |
| 全部 episode 奖励 均值 | 2001.4492 | 1755.2575 |
...
| Cohen's d_z | 7.9874 | 配对效应量（>0.8 大效应） |
| 95% CI (配对差值) | [233.4689, 258.9145] | 均值差的 95% 置信区间 |
| 事后功效 | 1.0000 | 当前样本量下的检验力（目标≥0.8） |
| 噪声奖励变化% | -12.30% | 负值=噪声导致奖励下降 |
| 变化% 95% CI | [-18.02%, -6.38%] | Bootstrap 95% CI |

## 四、结论

**统计结论**：在 α=0.05 显著性水平下，Wilcoxon signed-rank 检验表明
真机噪声分布对 PPO 策略奖励有**显著影响**（p=2.98e-08），
配对效应量 Cohen's d_z=7.9874 属于大效应。
