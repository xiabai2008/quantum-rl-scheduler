...
> 当前权威性能提升结论仍由仿真实验支撑（16维交付模型 PPO vs FCFS +123.4%, N=250, Welch t p=1.449e-66，见 `config/statistics.yaml`；旧14维口径 +88.3% 已废弃），
...
性能提升结论由仿真实验支撑：16维交付模型 PPO vs FCFS +123.4%（N=250, Welch t p=1.449e-66，旧14维口径 +88.3% 已废弃）。
