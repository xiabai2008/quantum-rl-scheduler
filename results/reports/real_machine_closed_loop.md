...
> **⚠️ 历史报告冻结声明（2026-07-29）**：本报告中引用的 50seed 仿真对比（+88.3%、p=1.032e-42）基于 14 维旧模型，**已废弃**。现行权威口径为 16 维交付模型：PPO vs 真实 FCFS **+20.2%**（N=250, Welch t p=7.56e-12, 8.5 基线诚实化；旧 +123.4% 为 vs Hybrid-Default 弱基线），见 `config/statistics.yaml`。本报告真机闭环链路验证结论不受影响，但仿真数字禁止直接引用。
...
> ⚠️ **历史快照声明（2026-08-14）**：本报告为 2026-07-27 真机闭环实验记录，下方旧数字仅作撰写时点追溯，
> **不得作为对外基准引用**。现行权威口径见 `config/statistics.yaml`（仿真 N=250 +20.2% / 真机 N=20 v3）。

- 50seed仿真（现行权威）：PPO=1982.69±557.25 vs FCFS=1648.91±502.95, 提升+20.2%, Welch t 检验 p=7.56e-12, rank-biserial=-0.3642（8.5 基线诚实化；旧 +88.3% 为 14 维口径已废弃）
- 多seed真机（v3 权威，8.14 扩样）：PPO=1632.26±326.49 vs FCFS=782.94±467.61, Cohen's d=2.11, p=1.22e-07, Bonferroni 校正后显著（v2 的 d=5.33 为小样本高估）
- 历史（撰写时点，已废弃）：50seed仿真 PPO=2746.94±1160.72 vs FCFS=1458.77±60.47, +88.3%, p=1.032e-42；多seed真机 PPO=1736.32±355.78 vs FCFS=383.00±49.13, d=5.33, p<0.001
