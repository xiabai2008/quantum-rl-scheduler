...
> **⚠️ 历史报告冻结声明（2026-07-29）**：本报告中引用的 50seed 仿真对比（+88.3%、p=1.032e-42）基于 14 维旧模型，**已废弃**。现行权威口径为 16 维交付模型：PPO vs FCFS **+123.4%**（N=250, Welch t p=1.449e-66），见 `config/statistics.yaml`。本报告真机闭环链路验证结论不受影响，但仿真数字禁止直接引用。
...
- 50seed仿真：PPO=2746.94±1160.72 vs FCFS=1458.77±60.47, 提升+123.4%, Mann-Whitney U 检验 p=1.032e-42, rank-biserial=-0.71
