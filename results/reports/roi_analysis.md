...
| 指标 | PPO | FCFS | 提升 | 统计检验 |
|:--|:--:|:--:|:--:|:--:|
| 平均奖励 | 2746.94±1160.72 | 1458.77±60.47 | +123.4% | Mann-Whitney U p=1.449e-66, Cohen's d=-2.14 |
...
| 仿真 p 值（Mann-Whitney U 检验） | 1.449e-66 | 仿真统计验证 | ✅ 锁定 |
...
> 注：仿真 p 值使用 Mann-Whitney U 检验（p=1.449e-66），与 AGENTS.md 权威口径一致。
