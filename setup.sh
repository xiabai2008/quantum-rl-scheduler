...
echo "    python scripts/training/quick_train.py"
echo ""
...
echo "    python scripts/evaluation/run_simulation.py"
echo ""
echo "    # Format & lint code"
echo "    ruff format src/ scripts/ tests/"
echo "    ruff check src/ scripts/ tests/"
echo ""
