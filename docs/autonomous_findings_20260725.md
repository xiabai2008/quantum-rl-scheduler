...
- Cohen's d=5.64（效应量异常大，小样本探索性结果需验证）, Welch p=6.83e-04（Bonferroni校正后显著）
...
- 多seed真机：PPO=1665.22±324.51 vs FCFS=353.22±53.33, Cohen's d=5.64（效应量异常大，小样本探索性结果需验证）, p=6.83e-04（Bonferroni校正后显著）
- 所有实验数据和PR必须与以上数字一致
