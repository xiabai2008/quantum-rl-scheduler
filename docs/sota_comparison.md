...
| **本系统 (v9.0)** | **2026** | **本项目** | **PPO-LSTM + QEM** | **多目标（吞吐/等待/利用率/串扰）** | **287（天衍-287）** | **+88.3%，p=1.032e-42** | **据调研首个集成误差缓释、串扰感知与LSTM流量预测的RL调度系统** |
...
| **本系统 (v9.0)** | **2026** | **本项目** | **RecurrentPPO** | **量子任务多目标调度** | **3量子机×200任务** | **比FCFS+88.3%** | **16维状态空间，据调研唯一支持空间并发、QEM与真机可用性验证** |
