...
### 核心创新
- **AI 赋能量子**：PPO强化学习智能调度量子/经典任务，PPO vs FCFS +88.3%
- **量子赋能 AI**：量子退火(QUBO映射)优化RL策略搜索（探索性方向；当前经典模拟退火，训练开销+74.5%，+6.4% p=0.9430不显著，20seeds权威值；旧5seed的p=0.190已废弃）
- **量化目标**：综合调度奖励提升 ≥30%（PPO 实测 +88.3%, N=250）；量子资源利用率为多目标权衡维度，非硬性指标（Issue #440）
...
| 实验 | 结果 |
|------|------|
| 8策略对比 | PPO 2746.94 vs FCFS 1458.77（+88.3%） |
| 消融D1-D5 | D1算法+88.3% > D4多机+86.3% > D5退火+6.4% > D2状态+2.1% |
