...
| 场景 | 使用维度 | 理由 |
|:--|:--|:--|
| **权威对比实验（50seed）** | 14维（原生） | 权威对比框架，PPO 模型为 ppo_best_model_14dim.zip |
...
| 答辩口径 | PPO +88.3% 为14维原生环境权威对比结果（ppo_best_model_14dim.zip），10维 Obs10Wrapper 仅用于 DQN 公平对比 |
...
| 仿真 p 值 | 3.04e-11 | 14维（原生环境） | Welch t 检验 |
| 仿真 Cohen's d | -1.70 | 14维（原生环境） | 同上 |
