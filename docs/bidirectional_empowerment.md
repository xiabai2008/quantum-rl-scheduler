...
| 指标 | PPO | FCFS | 提升 |
|------|-----|------|------|
| 平均奖励 | 2723.0 | 1462.48 | **+86.9%** |
| 量子比特利用率 | 89% | 51% | **+74.5%** |
| 任务吞吐量 | 23/h | 12/h | **+91.7%** |

- 实验条件：10 seed × 5 episode = 50 次独立运行；泊松 λ=0.5；量子任务占比 70%
- 8 策略排名：PPO(2723) > SJF(1468) > FCFS(1462) > Random(1276) > Greedy(-72) > DQN(-897) > Quantum-Only(-897) > Classical-Only(-1134)
...
| 维度 | 指标 | 数值 |
|------|------|------|
| AI→量子 | PPO 调度提升 | **+86.9%** (2723 vs 1462) |
