...
| 量子比特利用率 | 89% | 51% | **+74.5%** |
| 任务吞吐量 | 23/h | 12/h | **+91.7%** |

- 实验条件：10 seed × 5 episode = 50 次独立运行；泊松 λ=0.5；量子任务占比 70%
- 8 策略排名：PPO(2814) > SJF(1468) > FCFS(1462) > Random(1276) > Greedy(-72) > DQN(-897) > Quantum-Only(-897) > Classical-Only(-1134)
...
| 维度 | 指标 | 数值 |
|------|------|------|
| AI→量子 | PPO 调度提升 | **+92.4%** (2814 vs 1462) |
| AI→量子 | 利用率提升 | **+74.5%** (89% vs 51%) |
| AI→量子 | 吞吐量提升 | **+91.7%** (23/h vs 12/h) |
| 量子→AI | 退火训练加速 | **+74.5%** |
| 量子→AI | 最终奖励提升 | **+6.4%** |
...
| 维度 | 选型 | 依据 |
|------|------|------|
| 量子硬件 | 超导量子（祖冲之三号同款芯片/天衍-287） | 天衍云平台提供，72 qubits |
