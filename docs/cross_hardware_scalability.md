...
> 本文档作为答辩材料中的理论扩展性论述，说明当前调度框架的解耦设计及其向其他量子硬件后端扩展的理论路径。
>
> **Issue #210 文档碎片化整理**：本文档为跨硬件主题的主文档（答辩论述）。技术实施路线图与验收标准见 [cross_hardware_compatibility.md](cross_hardware_compatibility.md)（分册，已建立交叉引用）。
>
> 关联 Issue: #28
> 最后更新：2026-07-24
