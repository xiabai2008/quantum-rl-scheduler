...
| 3 | SJF | 748.48 | 304.86 | -54.6% | 2.28e-60（vs FCFS，Mann-Whitney U） |
| 4 | DQN (Random替代) | 697.40 | 288.25 | -57.7% | 2.79e-98 |
| 5 | Random | 697.40 | 288.25 | -57.7% | 2.79e-98 |
...
| DQN 占位 vs FCFS | -1046.54 | — | 2.79e-98 | Cohen's d=-2.60（大） | ⚠️ DQN 已删除（Random 占位）（8.8 重算，旧 5.681e-14 为过期值） |
