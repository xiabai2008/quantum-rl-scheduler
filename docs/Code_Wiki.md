...
| v8 | 50seed N=250验证 + 多seed真机实验 | PPO=1982.69±557.25, +20.2%, p=7.56e-12, rank-biserial=-0.3642；多seed真机PPO=1736.32±355.78 vs FCFS=383.00±49.13, d=5.33（效应量异常大，小样本探索性结果，需进一步验证）| | FCFS: 1648.91±502.95
...
# 排名：PPO(1982.69) > FCFS(1648.91) > SJF(774.86) > DQN/Random(602.37)
#       > Greedy(80.71) > Quantum-Only(-826.59) > Classical-Only(-1075.49)
```
