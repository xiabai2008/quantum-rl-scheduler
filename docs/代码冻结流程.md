...
>
> **Issue #210 文档碎片化整理**：本文档为代码冻结主题的"简化版流程"分册，主文档为 [code_freeze_checklist.md](code_freeze_checklist.md)（实操检查清单，6 大类 25 项）。流程与例外审批机制见 [code_freeze_policy.md](code_freeze_policy.md)。
