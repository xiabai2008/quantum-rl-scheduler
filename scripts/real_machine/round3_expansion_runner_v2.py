#!/usr/bin/env python
"""round3-B: 176 严格窗口模式实验（2026-08-09 v2）。

平台问题：tianyan176 状态在 running <-> calibration 间快速闪烁。
...
def main() -> int:
    parser = argparse.ArgumentParser(description="176 严格窗口模式 N=20 扩充实验 v2")
    ...
    data = {
        ...
        "experiment": "round3_expansion_20260809_v2",
