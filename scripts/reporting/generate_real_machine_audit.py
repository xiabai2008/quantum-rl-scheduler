...
@click.command()
@click.option("--input-dir", default="results/real_machine/tianyan287_multiseed", help="Input directory containing real machine JSON logs.")
@click.option("--output-file", default="results/reports/real_machine_audit_trail.md", help="Output Markdown file.")
def main(input_dir, output_file):
    ...
    for json_file in sorted(input_path.glob("*.json")):
        with open(json_file, "r", encoding="utf-8") as f:
            try:
                ...
                click.echo(f"Warning: Could not decode JSON from '{json_file}'. Skipping.", err=True)
                continue
    ...
    md_lines.append("![天衍云控制台截图](https://some-placeholder-image-url.com/tianyan_console_screenshot.png)")
