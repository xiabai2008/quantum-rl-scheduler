...
def generate_ppt(output_path: str) -> None:
    ...
    add_content_slide(
        ...
        [
            ...
            "第二层：编译层 — PPO替代SABRE比特映射，深电路SWAP减少+38.5%(N=80, Wilcoxon p=2.75e-02显著)",
    ...
    add_content_slide(
        ...
        [
            ...
            "  - 深电路(14-16q) SWAP减少+38.5%（N=80, Wilcoxon p=2.75e-02显著；全60电路p=0.86不显著，诚实披露）",
            "  - 原76.4%为不公平对比已废弃",
    ...
    add_content_slide(
        ...
        [
            ...
            "测试覆盖率：≥80%（CI 门禁 --cov-fail-under=80），主套件 3697 测试用例（8.6 起），0 ruff/mypy错误",
        ],
    )
