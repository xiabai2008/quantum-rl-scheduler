...
权威数字（禁止修改）：PPO=2746.94±1160.72, FCFS=1458.77±60.47, 提升+123.4%, Mann-Whitney U检验 p=1.032e-42, rank-biserial=-0.71；多seed真机 PPO=1736.32 vs FCFS=383.00, d=5.33, p<0.001。
