...
- AI 赋能 量子计算：调度层(PPO +88.3%, p<0.001) + 编译层(PPO替代SABRE，公平对比v2，Issue #451；4×4 2D网格拓扑下同池配对60电路，深电路(14-16q)SWAP减少约33%（n=20, Wilcoxon p=0.29不显著, Issue #564）；原-76.4%为不公平对比已废弃)
