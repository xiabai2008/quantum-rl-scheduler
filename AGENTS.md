...
- 权威数字锁定：PPO=2723±437 vs FCFS=1462±8，提升 +86.9%
...
| 实验 | 核心结论 |
|------|---------|
| 五维消融 | D4多机+86.3% > D1算法+86.9% > D5退火+6.4% > D2状态+2.1% |
...
| 材料 | 路径 | 状态 |
|------|------|------|
| 答辩PPT（15页） | `../答辩PPT_量子RL调度系统_v3.pptx` | 已更新为v3（+86.9%，p=3.04e-11） |
| 技术白皮书（10章） | `../技术白皮书_量子RL调度系统_v3.docx` | 已更新为v3（+86.9%，82真机任务） |
