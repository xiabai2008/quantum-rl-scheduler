...
- 测试文件：5 → 76（+71个专用测试模块）
- 测试用例：100+ → 3656（Issue #398 P1-4 统一口径，pytest --collect-only 实测，2026-08-02）
