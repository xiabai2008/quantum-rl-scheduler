...
**最后更新**：2026-08-01（Issue #203：VISUALIZATION_API_KEY 统一为 VIZ_API_KEY；Issue #771/#847：bandit B614 已通过 # nosec 注释处理（marl.py:723/1603），bandit -ll 实测 0 Medium+）
...
| 版本 | 支持状态 | 说明 |
|------|:--------:|------|
| 9.1.0 | :white_check_mark: | 当前版本（比赛提交版本） |
| < 9.1.0 | :x: | 不支持，请升级至最新版本 |

代码冻结日（2026-08-15）后，仅 9.1.0 版本接受安全修复。
...
- [x] 源代码中无硬编码凭证（Bandit 扫描通过，2026-07-25 修复 test_cqlib.py；2026-07-31 marl.py:723/1603 已补 # nosec B614，bandit -ll 实测 0 Medium+）
