...
| **MAPPO 多智能体** | `deliverable_models/mappo/mappo.pt` | 3 机协同 MAPPO（共享 Critic 投票仲裁），50K steps，seed=42 | ~323 KB | 严格同协议对比：4588.7 vs 独立PPO 4412.2（+4.0%）vs FCFS 923.9（+396.7%）；3 独立 PPO（independent_ppo_m0/1/2.zip，各 16K 步单机训练）随附 |
