...
| **PPO编译优化Agent** | `deliverable_models/ppo_compilation_agent.zip` | 量子比特映射任务专用PPO Agent，4×4 2D网格训练200k steps | ~160 KB | 公平对比v2：深电路(14-16q)SWAP减少~33%（n=20），整体p=0.86不显著（Issue #451） |
...
| 编译层PPO vs SABRE | 公平对比v2（4×4 2D网格, 60电路同池配对, Issue #451） | 深电路SWAP减少~33%（n=20），整体p=0.86不显著 |
