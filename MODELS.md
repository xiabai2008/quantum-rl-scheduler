...
> 本文件说明本项目**可提交的训练好的模型检查点**，用于保证评审在克隆仓库后能复现论文中的实验结果（PPO vs FCFS +92.4% 等）。
> 最后更新：2026-07-10
...
|------|-------------------|--------------------------|------|----------|
| **PPO** | `deliverable_models/ppo_best_model_10dim.zip` | `models/ppo_seed_42_v4/best_model.zip` | ~261 KB | PPO 奖励 **2814.19**（10 seed × 5 ep，+92.4% vs FCFS） |
...
```bash
# 1) 8 策略对比（加载 PPO/DQN 权威模型，复现 +92.4%）
